...
> [!NOTE]
> - Web app: [Turtle_image_classification]([https://huggingface.co/spaces/BugNo10/Turtle_image_classification](https://bugno10-turtle-image-classification.hf.space))
